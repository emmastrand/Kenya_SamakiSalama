...
for (i in cols){
  ...
  geom_boxplot(outlier.shape = NA, width=0.2, color="grey50", alpha=0.3) +
    theme_bw() +
  scale_color_manual(values = c("#11BF66", "#E78818", "#48B5B7")) +
  ...
  #ggsave(file = paste0("household groups/figures/", i, " jitter.png"), width = 3, height = 4, units = c("in"))
    ...
    ggsave(file = paste0("household groups/figures/", i, " violin-box.png"), width = 3, height = 4, units = c("in"))
}
```
