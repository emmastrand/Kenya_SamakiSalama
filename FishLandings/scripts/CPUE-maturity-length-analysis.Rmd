...
ggsave(file="output/Length_persurvey2.png", Legnth_persurvey2, width = 4, height = 4, units = c("in"))
...
ggsave(file="output/CPUE2.png", CPUE_n2, width = 4, height = 4, units = c("in"))
...
ggsave(file="output/Yield_reported2.png", Yield_reported2, width = 4, height = 4, units = c("in"))
...
ggsave(file="output/Value_reported2.png", Value_reported2, width = 4, height = 4, units = c("in"))
```
